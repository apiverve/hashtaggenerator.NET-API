...
namespace APIVerve
{
    public class HashtagGeneratorAPIClient
    {
        ...
        public HashtagGeneratorAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }

        public HashtagGeneratorAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public ResponseObj Execute(hashtaggeneratorQueryOptions options)
        {
            try
            {
                if (_isDebug)
